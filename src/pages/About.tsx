        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed text-lg font-light">
              Founded in Bhubaneswar, Odisha, Gurudev furniture was born from a simple yet powerful ideal: that a luxurious, restorative sleep is the foundation of a life well-lived.
            </p>
