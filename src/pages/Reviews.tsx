  ...
  const fallbackReviews: ReviewItem[] = [
    {
      name: "Aarav Patnaik",
      location: "Berhampur",
      text: "The Cloud Memory mattress changed my life. I used to wake up with back pain every morning, but since switching to Gurudev furniture, I feel completely rested.",
      rating: 5,
    },
    {
      name: "Sneha Mishra",
